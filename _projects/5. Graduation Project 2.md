...
image: https://www.hydropoint.com/wp-content/uploads/What-is-smart-irrigation-1.jpeg
description: Smart Irrigation System with Arduino
...
- The main aim of the project is to create a baseline smart irrigation system which can be used to irrigate a single plant but can be scaled up for the usage of any number of plants.
- The parts used here are relatively inexpensive in terms of the value it provides, Total approximate cost we incur was less than ₹1500(~$25CAD).
