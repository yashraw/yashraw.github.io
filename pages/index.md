...
<div class="row align-items-start home-hero-row">
  ...
  <div class="col-md-6 col-12">
    {% include home-manufacturing-carousel.html %}
  </div>
</div>
...
#### I currently work as a Process Engineer at PowerCor, a [Linamar](https://www.linamar.com/) facility, where I optimize production processes and hold the line on quality standards. I hold a Mechanical Engineering Technology - Industrial diploma from [Centennial College](https://www.centennialcollege.ca/).
...
#### This site runs on [GH-Pages](https://pages.github.com/) and [Jekyll](https://jekyllrb.com/docs/github-pages/) — built as an extension of my resume and a home base for the projects, writing, and experiments I want to put into the world.

#### Want the full story? Check out my [about page](./about/).
